...
{
    public class LocationAndClasses : AbstractBaseRestCallSetup
    {
        public LocationAndClasses(TokenModel generatedToken, TokenModel userToken) : base(generatedToken, userToken)
        {
        }
