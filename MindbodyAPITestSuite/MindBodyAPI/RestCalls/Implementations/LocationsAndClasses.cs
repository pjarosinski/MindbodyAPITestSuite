...
{
    public class LocationsAndClasses : AbstractBaseRestCallSetup, ILocationsAndClasses 
    {
        public LocationsAndClasses(TokenModel generatedToken, TokenModel userToken) : base(generatedToken, userToken)
        {
        }
