...
{
    public class Favorites : AbstractBaseRestCallSetup, IFavorites 
    {
        public Favorites(TokenModel generatedToken, TokenModel userToken) : base(generatedToken, userToken)
        {
        }
